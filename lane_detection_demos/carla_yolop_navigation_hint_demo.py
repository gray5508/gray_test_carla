"""
carla_yolop_navigation_hint_demo.py

Realtime CARLA + YOLOP lane-segmentation navigation hint demo.
...
def parse_args():
    parser = argparse.ArgumentParser(
        description="Realtime CARLA YOLOP navigation-intent arrow demo.",
...
def main():
    ...
    pygame.display.set_caption("CARLA YOLOP nav hint | 1/2/3 | C clear | ESC quit")
    ...
    print("Realtime YOLOP navigation hint demo")
    ...
    try:
        ...
        while running:
            ...
            hud = [
                ...
                "Straight draws current-lane center; left/right wait for matching curve geometry.",
            ]
